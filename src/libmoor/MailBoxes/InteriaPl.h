...
#ifndef __INTERIAPL_H
#define __INTERIAPL_H

#include <string>
#include "../Mailbox.h"

class InteriaPlMailbox: public CMailBox
{
	...
	public:
                 ...
                 */
                InteriaPlMailbox(const std::string &name, const std::string &usr, const std::string &passwd);
		~InteriaPlMailbox();
